...
{
	int (*MImage_new2D)(mint /* width */, mint /* height */, mint /* channels */, imagedata_t /* type */,
						colorspace_t /* colorSpace */, mbool /* interleaving */, MImage* /* result */);
	int (*MImage_new3D)(mint /* slices */, mint /* width */, mint /* height */, mint /* channels */,
						imagedata_t /* type */, colorspace_t /* colorSpace */, mbool /* interleaving */,
						MImage* /* result */);

...
struct st_MInputStream
{
	...
	int (*Mfseek)(struct st_MInputStream*, int64_t offset);
	int (*Mfeof)(struct st_MInputStream*);
	int64_t (*Mftell)(struct st_MInputStream*);

	char* (*MferrorText)(struct st_MInputStream*);
	void (*Mclearerr)(struct st_MInputStream*);
	int64_t (*Mstreamsize)(struct st_MInputStream*);
...
struct st_MOutputStream
{
	...
	int64_t (*Mftell)(struct st_MOutputStream*);
